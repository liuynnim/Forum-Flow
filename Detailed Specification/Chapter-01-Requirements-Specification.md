...
- [1.0. Sơ đồ Use Case Tổng quan (Overview)](#10-sơ-đồ-use-case-tổng-quan-overview)
...
## 1.0. Sơ đồ Use Case Tổng quan

Sơ đồ dưới đây thể hiện bức tranh tổng thể về các chức năng chính (High-level Use Cases) mà hệ thống **Forum-Flow** cung cấp cho từng nhóm người dùng, giúp người đọc hình dung nhanh các nhóm tính năng trước khi đi sâu vào chi tiết.

![Sơ đồ Use Case tổng quan](image/overview_use_case.png)
...
![Sơ đồ Use Case - Khách (Guest)](image/guest_use_case.png)
...
| G-AUTH-02 | **Đăng nhập**             | Hỗ trợ 2 phương thức: _(i)_ JWT (Email/Password), _(ii)_ OAuth2 (Google, GitHub). |
...
| G-FORUM-03 | **Tìm kiếm & Lọc bài viết**  | Tìm kiếm theo từ khóa (Full-text search); lọc theo Tags; sắp xếp theo: _Mới nhất, Hot nhất, Nhiều lượt xem_. |
...
![Sơ đồ Use Case - Thành viên (Member)](image/member_use_case.png)
...
| M-NOTIF-02 | **Sự kiện kích hoạt thông báo** | Gồm 4 sự kiện: _(i)_ Có người **Upvote** bài viết của mình, _(ii)_ Có người **Comment** vào bài của mình, _(iii)_ Được **Mention** (`@username`) trong bài viết/comment, _(iv)_ Nhận **Tin nhắn Chat** mới. |
...
![Sơ đồ Use Case - Kiểm duyệt viên (Moderator)](image/moderator_use_case.png)
...
| MOD-REPORT-02 | **Xử lý Báo cáo**         | Thực hiện một trong hai hành động: _(i)_ **Phê duyệt** — xác nhận vi phạm, tiến hành xóa nội dung; _(ii)_ **Bác bỏ** — đánh dấu báo cáo là không hợp lệ. |
...
![Sơ đồ Use Case - Quản trị viên (Admin)](image/admin_use_case.png)
...
_Tài liệu này là một phần của bộ Detailed Specification cho dự án **Forum-Flow**._  
_Xem các chương tiếp theo để biết chi tiết về Kiến trúc Hệ thống, Thiết kế Cơ sở Dữ liệu và Đặc tả API._
